...
{
	/// <summary>
	/// Summary description for ParseTest
	/// </summary>
	[TestFixture]
	public class ParseTest
	{
		...
		[Test]
		public void ComplexShortTest()
		{
			string[] args = new[] { "-acbtoast", "foo", "bar" };
		...
		{
			string[] args = new[] { "-adbtoast", "foo", "bar" };
		...
		{
			string[] args = new[] { "-c", "foobar", "-btoast" };
		...
		{
			string[] args = new[] { "-c", "foober", "-btoast" };
